...
opt.lazyredraw = false -- Keep redrawing for smooth interaction
opt.synmaxcol = 300    -- Increase syntax highlighting column limit
opt.redrawtime = 10000 -- Time in milliseconds for redrawing the display
